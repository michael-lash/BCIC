...
load('~/ARIC/experiment/logistic_regression/glmnet_model_aric.mat');
...
save('~/ARIC/experiment/logistic_regression/result/sens_aric_recommend_kernel_s1.mat','Prob');
